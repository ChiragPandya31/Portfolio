...
function Home() {
  return (
    <section>
      <Helmet>
        <title>Chirag Pandya - Developer Portfolio</title>
        <meta name="description" content="Chirag Pandya's personal website showcasing development skills and projects using React.js." />
          ...
          <Row>
            <Col md={7} className="home-header">
              ...
              <h1 className="heading-name">
                I'M
                <strong className="main-name"> Chirag Pandya</strong>
              </h1>
